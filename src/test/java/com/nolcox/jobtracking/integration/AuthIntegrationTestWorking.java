...
/**
 * Working Integration tests for authentication functionality.
 * Tests the complete authentication flow using the service layer.
 */
@SpringBootTest
@ActiveProfiles("test")
@TestPropertySource(properties = {
        ...
        "app.jwt.secret=testSecretKeyForJWTTokenGenerationWhichShouldBeAtLeast256Bits",
        "app.jwt.expiration=86400000"
})
@Transactional
class AuthIntegrationTestWorking {
